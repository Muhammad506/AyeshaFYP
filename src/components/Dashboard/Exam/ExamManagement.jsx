...
//                                                     <Link to="/dashboard/create-questions" >
//                                                         <FaClipboardList
...
const ExamManagement = () => {
  return (
    <div className="min-h-screen  p-6">
      {/* Header Section */}
      <header className="flex justify-between items-center bg-blue-200 p-4 rounded-t-lg shadow">
        <h1 className="text-lg font-bold text-blue-900">SE Quiz Clos</h1>
        <button className="text-blue-700 font-medium hover:underline">Logout</button>
      </header>

      {/* Form Section */}
      <form className="bg-blue-300 p-6 rounded-lg shadow mt-4 flex flex-wrap gap-4">
        {/* Course Name */}
        <div className="flex flex-col">
          <label className="text-sm font-medium text-blue-800">Course Name</label>
          <select className="border rounded-md p-2 text-sm bg-white">
            <option>Software Re-engineering</option>
          </select>
        </div>

        {/* Quiz */}
        <div className="flex flex-col">
          <label className="text-sm font-medium text-blue-800">Quiz</label>
          <input
            type="text"
        ...
        {/* Question */}
        <div className="flex flex-col">
          <label className="text-sm font-medium text-blue-800">Question</label>
          <input
            type="text"
        ...
        {/* CLO's */}
        <div className="flex flex-col">
          <label className="text-sm font-medium text-blue-800">CLO’s</label>
          <select className="border rounded-md p-2 text-sm bg-white">
        ...
        {/* Total Marks */}
        <div className="flex flex-col">
          <label className="text-sm font-medium text-blue-800">Total Marks</label>
          <input
            type="text"
        ...
        {/* Complexity */}
        <div className="flex flex-col">
          <label className="text-sm font-medium text-blue-800">Complexity</label>
          <select className="border rounded-md p-2 text-sm bg-white">
            <option>Select</option>
          </select>
        </div>
      ...
      <div className="overflow-x-auto  p-4  mt-4">
        <table className="table-auto w-full text-sm text-blue-800">
          <thead>
            <tr className="bg-blue-300">
              <th className="px-4 py-2">Course Name</th>
              <th className="px-4 py-2">Quiz</th>
              <th className="px-4 py-2">Question</th>
              <th className="px-4 py-2">CLO’s</th>
          ...
          <tbody>
            <tr>
              <td className="border px-4 py-2">Software Re-engineering</td>
